...
Find the DataSet here: https://data.world/nrippner/cancer-linear-regression-model-tutorial
...
The features in this category include the following: `medIncome`, `povertyPercent`, `AvgHouseholdSize`, `PercentMarried`, `PctMarriedHouseholds`
The proposed candidate feature is `medianIncome`
(Plot all below though)

```{r, fig.width=10, fig.height=10}
features <- list('medIncome', 'povertyPercent',
...
```{r}
write.csv(df_state_ohe,'Data/geography_cleaned.csv', row.names = FALSE)
```
